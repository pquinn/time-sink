...
// multimethod.py --arg=ICollideable:object1 --arg=ICollideable:object2 --result=void --name=OnCollidedWith
using System;
...
namespace TimeSink.Engine.Core.Collisions
{
    ...
    internal static class OnCollidedWith
    {
        ...
        public static void Invoke(ICollideable object1, ICollideable object2)
        {
            ...
            if (ms_nextIndex > 0)
                if (DoLeftPrecedesRight(ms_candidates[__index], ms_candidates[ms_nextIndex]) == 0)
                    throw new AmbiguousMatchException(string.Format("Invoke found ambiguous overloads for OnCollidedWith({0}).", __actual));

            ms_candidates[__index].Method(object1, object2);
        }
        ...
        // MissingMethodException or System.Reflection.AmbiguousMatchException.
        public static void NextMethod(ICollideable object1, ICollideable object2)
        {
            var __actual = new Entry(object1, object2);
        ...
        private delegate void OverloadType(ICollideable object1, ICollideable object2);

        private struct Entry : IEquatable<Entry>
        {
            public Entry(ICollideable object1, ICollideable object2)
                : this()
            {
                Method = null;
                Type1 = (object)object1 != null ? object1.GetType() : null;
                Type2 = (object)object2 != null ? object2.GetType() : null;
            }
