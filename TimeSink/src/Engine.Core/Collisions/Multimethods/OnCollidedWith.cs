...
// multimethod.py --result=void --name=OnCollidedWith --arg=ICollideable:obj1 --arg=ICollideable:obj2 --arg=Contact:info --namespace=TimeSink.Engine.Core.Collisions
using System;
...
namespace TimeSink.Engine.Core.Collisions
{
	...
	public static class OnCollidedWith
	{
		...
		public static void Invoke(ICollideable obj1, ICollideable obj2, Contact info)
		{
		...
		public static void NextMethod(ICollideable obj1, ICollideable obj2, Contact info)
		{
			var __actual = new Entry(obj1, obj2, info);
		...
		public static void Register(Type type)
		{
			...
			foreach (MethodInfo info in type.GetMethods(MethodBinding))
			{
				if (info.IsDefined(typeof(OverloadAttribute), false))
				{
					...
					{
						entry = new Entry(
							(ICollideable a1, ICollideable a2, Contact a3) => temp.Invoke(null, new object[]{a1, a2, a3}),
							parms[0].ParameterType, parms[1].ParameterType, parms[2].ParameterType);
					}
					else
					{
						entry = new Entry(
							(ICollideable a1, ICollideable a2, Contact a3) => temp.Invoke(a1, new object[]{a2, a3}),
		...
		private delegate void OverloadType(ICollideable obj1, ICollideable obj2, Contact info);
