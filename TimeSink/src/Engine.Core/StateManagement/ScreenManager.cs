...
namespace TimeSink.Engine.Core.StateManagement
{
    ...
    public class ScreenManager : DrawableGameComponent
    {
        ...
        int frameWidth = GraphicsAdapter.DefaultAdapter.CurrentDisplayMode.Width;
        int frameHeight = GraphicsAdapter.DefaultAdapter.CurrentDisplayMode.Height;
        ...
        protected override void LoadContent()
        {
            ...
            blankTexture = content.Load<Texture2D>("Materials/blank");
