...
namespace TimeSink.Engine.Core.Particles
{
    public class Particle : IRenderable
    {
        ...
        public Particle(Vector2 Position, Vector2 StartDirection, Vector2 EndDirection, float StartingLife, float ScaleBegin, float ScaleEnd, Color StartColor, Color EndColor, string texture, IResourceCache<Texture2D> textureCache)
        {
