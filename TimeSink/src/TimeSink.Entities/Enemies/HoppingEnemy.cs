...
namespace TimeSink.Entities.Enemies
{
    ...
    public class HoppingEnemy : Enemy
    {
        private const float CENTIPEDE_MASS = 100f;
        private const string CENTIPEDE_TEXTURE = "Textures/Enemies/Centipede/Neutral";
        private const string EDITOR_NAME = "Hopping Enemy";
        ...
        public HoppingEnemy(Vector2 position)
            : base(position)
        {
        }
