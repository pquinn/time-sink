...
// multimethod.py --arg=ICollisionGeometry:shape1 --arg=ICollisionGeometry:shape2 --result=bool --name=Collided
using System;
...
namespace MechanicsTest.Collisions
{
    ...
    internal static class Collided
    {
        ...
        public static bool Invoke(ICollisionGeometry shape1, ICollisionGeometry shape2)
        {
        ...
        // MissingMethodException or System.Reflection.AmbiguousMatchException.
        public static bool NextMethod(ICollisionGeometry shape1, ICollisionGeometry shape2)
        {
            var __actual = new Entry(shape1, shape2);
        ...
        public static void Register(Type type)
        {
            ...
            foreach (MethodInfo info in type.GetMethods(MethodBinding))
            {
                if (info.IsDefined(typeof(OverloadAttribute), false))
                {
                    ...
                    {
                        entry = new Entry(
                            (ICollisionGeometry a1, ICollisionGeometry a2) => (bool)temp.Invoke(null, new object[] { a1, a2 }),
                            parms[0].ParameterType, parms[1].ParameterType);
                    }
                    else
                    {
                        entry = new Entry(
                            (ICollisionGeometry a1, ICollisionGeometry a2) => (bool)temp.Invoke(a1, new object[] { a2 }),
        ...
        private delegate bool OverloadType(ICollisionGeometry shape1, ICollisionGeometry shape2);

        private struct Entry : IEquatable<Entry>
        {
            public Entry(ICollisionGeometry shape1, ICollisionGeometry shape2)
                : this()
            {
                Method = null;
            ...
            public Entry(OverloadType overload, Type type1, Type type2)
                : this()
            {
                Method = overload;
                Type1 = type1;
